...
class TabBar extends Component<Props, State> {
  ...
  renderTab = (
    ...
    const backgroundLineColor = this.props.backgroundLineColor ? this.props.backgroundLineColor : 'rgba(48,53,57,0.07)';
    const marginBottomLine = this.props.backgroundLineColor ? 0 : 1;
    return (
      <TouchableOpacity
        key={page}
      ...
      >
        ...
        <View style={{height:2, backgroundColor:backgroundLineColor, marginBottom:marginBottomLine}} />
      </TouchableOpacity>
    );
  };
